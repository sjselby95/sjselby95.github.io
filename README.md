...
- **games/** — Games hub (`games/index.html`), themed as an RTX 3060; links self-contained browser games (fossil-words, dino-match, animal-match, bone-quarry, plate-run, thagomizer), newest first. See `games/README.md` for integration notes (esp. the `voice.mp3` audio-sprite constraint in bone-quarry)
